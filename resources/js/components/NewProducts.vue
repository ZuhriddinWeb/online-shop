...
<div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
    ...
    <main class="flex flex-wrap w-full">
            <router-link v-for="item,index in new_products" :to="{name:'product-view', params: {id: item.product_id}}"  class="px-2 md:w-1/4 xl:w-1/5 cursor-pointer border-gray-50" >
